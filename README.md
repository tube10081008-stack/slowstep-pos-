...
| 5 | **게이미피케이션 멤버십** | 스탬프·등급·미션 + **취향 프로필·도장깨기·해피아워·친구초대** |
| 5-0 | **행운의 룰렛** | 스탬프·연속방문으로 기회를 모아 **손님 폰에서 직접** 돌린다. 보상은 포인트가 아니라 **쿠폰** |
| 5-3 | **연속 방문 두 갈래** | 5일 연속 / 4주 연속 각각 룰렛 기회. 매일 오는 손님과 주 1회 단골을 함께 챙긴다 |
| 5-4 | **월간 랭킹 2부문** | 금액·횟수를 따로 매겨 TOP3 시상. 매달 초기화 |
